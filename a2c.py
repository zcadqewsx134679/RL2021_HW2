...
class Policy(nn.Module):
    ...
    def __init__(self):
        ...
        self.policy1 = nn.Linear(self.hidden_size, self.action_dim)
        
        self.value1 = nn.Linear(self.hidden_size, 1)
    ...
    def forward(self, state):
        ...
        #policy network 
        action_prob = F.softmax(self.policy1(state))
        
        #value network 
        state_value = self.value1(state)
